...
@section('title', 'HFRO | Edit Partner')
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-3 align-items-end">
            <div class="col-sm-6">
                <h1 class="font-weight-bold text-dark mb-0">Edit Partner</h1>
                <p class="text-muted mb-0 small">Update the details for <strong>{{ $partner->name }}</strong>.</p>
            </div>
            <div class="col-sm-6">
...
<section class="content">
    <form method="POST" action="{{ route('admin.partners.update', $partner->id) }}" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                {{-- LOGO PANEL --}}
                <div class="card shadow-sm border-0 mb-4" x-data="{ logoPreview: '{{ $partner->logo ? asset('storage/' . $partner->logo) : null }}' }">
                        ...
                        <div class="logo-upload-zone rounded mb-3" 
                            ...
                            <template x-if="!logoPreview">
                                <div class="py-4 text-muted">
                                    ...
                                    <p class="extra-small text-muted">Current: No logo uploaded</p>
                                </div>
                            </template>
                        </div>

                        <label for="logo" class="btn btn-outline-primary btn-sm btn-block rounded-pill mb-0">
                            <i class="fas fa-sync-alt mr-1"></i> Change Logo
                        </label>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary btn-block py-2 font-weight-bold shadow-sm rounded-pill mb-2">
                            <i class="fa fa-save mr-2"></i> Update Changes
                        </button>
...
<style>
    ...
    .border-primary { border-color: #007bff !important; border-style: solid !important; }
