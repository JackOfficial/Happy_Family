...
<section class="content">
  ...
  <div class="card shadow-sm">
    ...
    <div class="card-body">
        ...
        <fieldset class="border rounded p-3 mb-4">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" name="phone" id="phone" class="form-control" value="{{ old('phone', $team->phone) }}">
            </div>

            <div class="col-md-12 mb-3">
              <label for="bio" class="form-label">Short Bio</label>
              <textarea name="bio" id="bio" rows="4" class="form-control" placeholder="Write a short biography...">{{ old('bio', $team->bio) }}</textarea>
            </div>
          </div>
        </fieldset>
     ...
     x-data="{
       preview: null,
       current: '{{ $team->profilePhoto ? asset('storage/' . $team->profilePhoto->file_path) : '' }}'
     }">
              ...
              <div class="mt-3 text-center row">
                ...
                <template x-if="current" class="col-md-6">
                    <div>
                       <p class="text-muted mb-2">Current Photo:</p>
                  <img :src="current" alt="Current Photo" class="img-thumbnail mb-2" style="max-height: 150px; border-radius: 10px;"> 
                    </div>
                </template>

                <template x-if="preview" class="col-md-6">
                  <div>
                    <p class="text-muted mb-1">New Preview:</p>
                    <img :src="preview" alt="Preview" class="img-thumbnail shadow-sm" style="max-height: 150px; border-radius: 10px;">
                  </div>
                </template>
              </div>
            </div>
