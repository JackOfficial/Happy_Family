...
<style>
    ...
    .text-purple { color: var(--primary-purple) !important; font-weight: 700; }
    .text-pink { color: var(--accent-pink) !important; }
    .tracking-widest { letter-spacing: 0.2rem; }
    .opacity-90 { opacity: 0.9; }
    .opacity-70 { opacity: 0.7; }
    .display-3 { font-size: calc(1.5rem + 3.5vw); line-height: 1.1; font-weight: 800; }
    ...
    /* ---------------------------------------------------------
       3. HERO CAROUSEL & GLASSMORPHISM
    ------------------------------------------------------------ */
    .carousel-item { background: #000; position: relative; }
    .banner-img { object-fit: cover; filter: brightness(0.6); width: 100%; height: 100%; }
    ...
    .carousel-caption { z-index: 2; bottom: 0; top: 0; left: 0; right: 0; }
    ...
    /* Indicators & Controls */
    .custom-indicators [data-bs-target], .custom-indicators li {
        width: 12px; height: 12px; border-radius: 50%; margin: 0 8px;
        background-color: rgba(255,255,255,0.5); border: none; transition: 0.3s;
    }
    .custom-indicators .active, .custom-indicators li.active {
    ...
    ------------------------------------------------------------ */
    .btn-modern, .btn-hero {
        border-radius: 12px; padding: 15px 35px; font-weight: 700;
        text-transform: uppercase; letter-spacing: 1px; transition: all 0.3s ease;
        border: none;
    }
    .btn-modern:hover, .btn-hero:hover, .btn-modern-accent:hover {
    ...
    .btn-modern-accent {
        ...
        padding: 10px 25px; border-radius: 6px; font-weight: 600; text-decoration: none;
    }
    .btn-modern-purple {
        background: var(--primary-purple); color: #ffffff !important;
        border-radius: 8px; padding: 12px 25px; font-weight: 700;
        border: 2px solid var(--primary-purple); transition: 0.3s;
    }
    .btn-modern-purple:hover { background: var(--accent-pink); border-color: var(--accent-pink); }

    /* ---------------------------------------------------------
       5. IMPACT & PROJECT CARDS
    ------------------------------------------------------------ */
    ...
    .impact-card:hover, .project-card:hover {
        transform: translateY(-10px); box-shadow: 0 20px 40px rgba(99, 16, 132, 0.12);
    }
    ...
    .impact-overlay, .project-card .overlay {
        position: absolute; top: 0; left: 0; width: 100%; height: 100%;
        background: rgba(99, 16, 132, 0.7); display: flex; align-items: center;
        justify-content: center; opacity: 0; transition: 0.4s; z-index: 2;
    }
    .impact-card:hover .impact-overlay, .project-card:hover .overlay { opacity: 1; }

    /* ---------------------------------------------------------
       6. SPECIAL SECTIONS (ABOUT, PARTNERS, TABS)
    ------------------------------------------------------------ */
    .impact-section, .about-section { background-color: var(--soft-purple); }
    
    .image-wrapper::before {
        content: ''; position: absolute; width: 100%; height: 100%;
        border: 2px solid var(--accent-pink); top: 20px; left: -20px;
    ...
    .partner-logo-wrap {
        background: #fff; height: 120px; display: flex; align-items: center;
        justify-content: center; padding: 20px; border-radius: 15px;
        border: 1px solid #eee; transition: 0.4s;
    }
    .partner-logo { filter: grayscale(100%); opacity: 0.7; transition: 0.4s; max-height: 80px; }
    .partner-item:hover .partner-logo-wrap { border-color: var(--accent-pink); transform: translateY(-5px); }
